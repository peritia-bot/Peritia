...
function sendMessage(){
    ...
    if (firstStagePassed == false){
        if (userMessage.toLowerCase().includes('procrastination')){
            ...
            botCell1.innerHTML = "<p id='introtest'><strong>Peritia: </strong><br>Procrastination can certainly feel like a tough cycle to escape, so the first step is to take a breath and let go of self-critical thoughts. Everyone procrastinates, and while it is certainly tough, you can get out of this mindset with the right help! So what exacly seems to be the problem?<br><br><button id='wastingTime' onclick='wastingTime()'>I feel like I'm wasting time</button><br><button id='cantFocus' onclick='cantFocus()'>I just can't focus</button></p>";
